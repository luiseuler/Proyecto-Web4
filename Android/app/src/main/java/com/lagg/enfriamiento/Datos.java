...
public class Datos extends AppCompatActivity {
    ...
    /*private void agregar() {
        if(etTipo.getText().length() < 1 && etValor.getText().length() < 1) {
            Toast.makeText(com.example.smarthomefull.MainActivity2.this, "Faltan datos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        StringRequest peticion = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(com.example.smarthomefull.MainActivity2.this, "Error de red", Toast.LENGTH_SHORT).show();
                    }
                }){
                    @Override
    ...
    private void agregarRespuesta(String response) {
        try {
            ...
            if(r.getString("add").compareTo("y")==0){
                Toast.makeText(Datos.this, "Almacenado correctamente", Toast.LENGTH_SHORT).show();
                llenar();
            }else{
                Toast.makeText(Datos.this, "Error no se pudo agregar", Toast.LENGTH_SHORT).show();
            }
        }catch (Exception e){}
    }
    ...
    private void llenar() {
        ...
        JsonArrayRequest peticion = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Datos.this, "Error de red", Toast.LENGTH_SHORT).show();
                    }
                }){
                    @Override
                    public Map<String,String> getHeaders() throws AuthFailureError {
        ...
        try{
            ...
            rvMsg.setAdapter(new MiAdapter(lista, new RecyclerViewOnItemClickListener() {
                ...
                public void onClickDel(View v, int position) {
                    new AlertDialog.Builder(Datos.this)
                            .setTitle("Eliminar")
            ...
            Toast.makeText(Datos.this, "Lista actualida", Toast.LENGTH_SHORT).show();
        }catch (Exception e){}
    }
